    ...
    <>
      ...
      <main className="container mx-auto my-20 px-20 max-md:px-4 min-h-[70vh]">
        <h2 className="text-primary-color font-bold text-2xl">
          {pet.nome} / <span className="text-secondary-color font-medium">{pet.usuario.cidade}</span>
        </h2>
        <div className="mt-6 flex gap-8 max-sm:flex-col">
          ...
          <section className="flex-1">
            ...
            <div className="mt-8 flex gap-4 max-lg:flex-col">
                ...
                >
                  <a 
                    href={`https://api.whatsapp.com/send?phone=55${pet.usuario.telefone}&text=Ol%C3%A1.%20Tudo%20bem?%20Tenho%20interesse%20na%20ado%C3%A7%C3%A3o%20respons%C3%A1vel%20do%20pet%20${pet.nome}.`} 
                    target="_blank"
