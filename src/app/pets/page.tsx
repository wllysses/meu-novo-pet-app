  ...
  return (
    <>
      ...
      <main className="container mx-auto my-12 p-4">
        <section className="w-full px-4 py-8 bg-secondary-color rounded flex items-center justify-center flex-col gap-2 text-white animate-fade-down">
        ...
        <section className="w-full mt-16 animate-fade-up">
          ...
          <div className="w-full mt-12 min-h-[60vh] grid grid-cols-5 gap-8 max-xl:grid-cols-4 max-lg:grid-cols-3 max-md:grid-cols-2">
            {pets && pets.map((pet) => <Card key={pet.id} data={pet} />)}
          </div>
        </section>
      </main>
      <Footer />
